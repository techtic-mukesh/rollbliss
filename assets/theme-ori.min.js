...
theme.config.isTouch&&(document.documentElement.className+=" supports-touch");console&&console.log&&console.log("ICONIC theme ("+theme.settings.themeVersion+") by ARCH\u039eTYPE | Learn more at ");theme.recentlyViewed={recent:{},productInfo:{}};window.lazySizesConfig=window.lazySizesConfig||{};lazySizesConfig.expFactor=4;
